...
import com.spnv.dechipherer.camera.CameraManager;
import com.spnv.dechipherer.camera.ShutterButton;
import com.spnv.dechipherer.language.LanguageCodeHelper;
import com.spnv.dechipherer.language.TranslateAsyncTask;
...
public final class CaptureActivity extends Activity implements SurfaceHolder.Callback, 
  ...
  private static final int texted=Menu.FIRST+4;
  ...
  public void onCreateContextMenu(ContextMenu menu, View v,
    ...
    if (v.equals(ocrResultView)) {
      ...
      menu.add(Menu.NONE, texted,Menu.NONE,"translate");
  ...
  public boolean onContextItemSelected(MenuItem item) {
    ...
    switch (item.getItemId()) {
      case texted:
        ...
        i.putExtra("OcrText", ocrResultView.getText().toString());
        startActivity(i);
