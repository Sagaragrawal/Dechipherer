...
public class caputre1 extends Activity implements OnClickListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_capute1);
		...
		pickButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				startActivityForResult(new Intent(Intent.ACTION_PICK, MediaStore.Images.Media.EXTERNAL_CONTENT_URI), IMAGE_PICKER_REQUEST);
			}
		});
	...
	public void onClick(View v) {
		...
		if (fileName != null && !apiKey.equals("") && !langCode.equals("")) {
			final ProgressDialog dialog = ProgressDialog.show( caputre1.this, "Loading ...", "Converting to text.", true, false);
				...
				public void run() {
					...
					runOnUiThread(new Runnable() {
						...
						public void run() {
							...
							final AlertDialog.Builder alert = new AlertDialog.Builder(caputre1.this);
			...
			Toast.makeText(caputre1.this, "All data are required.", Toast.LENGTH_SHORT).show();
		}
	}
